...
export function HeroSection() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 pt-28 lg:pt-20 animate-gradient">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto lg:mx-0 text-pretty leading-relaxed animate-fade-in-up animate-stagger-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-12 animate-fade-in-up animate-stagger-4">
              <Button 
                size="lg" 
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 text-lg cursor-pointer animate-hover-lift animate-pulse-soft"
                onClick={() => {
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white px-8 py-4 text-lg bg-transparent cursor-pointer animate-hover-lift"
                onClick={() => {
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 text-sm text-gray-600 animate-fade-in-up animate-stagger-5">
          ...
          <div className="relative animate-fade-in-right animate-stagger-2">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-6 border border-emerald-100 animate-bounce-in animate-stagger-4">
